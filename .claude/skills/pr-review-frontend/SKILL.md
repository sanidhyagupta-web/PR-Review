...
- If only a number is given, default to `sanidhyagupta-web/HealthCare`
...
- Extract ticket ID from PR title, branch name, or body (pattern: `TES3-\d+`)
...
- Root `CLAUDE.md`
- `HealthCare/ui/CLAUDE.md` (if accessible)
